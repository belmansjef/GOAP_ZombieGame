...
start GPP_TEST_RELEASE.exe -x 0 -y 490 -s 35
start GPP_TEST_RELEASE.exe -x 480 -y 490 -s 35
start GPP_TEST_RELEASE.exe -x 960 -y 490 -s 41
start GPP_TEST_RELEASE.exe -x 1240 -y 490 -s 41
